...
$lang['User_admin_explain'] = '<b>Username and Email address can be changed only from your main admin interface!</b><p>Here you can change your user\'s information and certain specific options. To modify the users permissions please use the user and group permissions system.';
