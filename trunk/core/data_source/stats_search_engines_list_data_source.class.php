...
require_once(LIMB_DIR . 'core/model/stats/stats_search_engines_report.class.php');

class stats_search_engines_list_data_source extends data_source
{		
	var $stats_report = null;
	
	function stats_search_engines_list_data_source()
	{
