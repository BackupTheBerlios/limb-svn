 ...
 *
 *   $Id: functions.php,v 1.1 2003/07/04 18:37:56 pacha Exp $
 *
 *
 ***************************************************************************/
...
function get_file_path($file_name, $include_dir='')
{
	...
	if(!file_exists($dir . $file_name))
		message_die(CRITICAL_ERROR, 'Could not find file ' . $file_name . ' in ' . $include_dir, '', __LINE__, __FILE__);
