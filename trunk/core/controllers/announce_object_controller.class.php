...
***********************************************************************************
*
* $Id: announce_object_controller.class.php 245 2004-03-05 12:11:42Z server $
*
***********************************************************************************/
require_once(LIMB_DIR . 'core/controllers/site_object_controller.class.php');
require_once(LIMB_DIR . 'core/lib/locale/strings.class.php');
	
class announce_object_controller extends site_object_controller
{
	function announce_object_controller()
	{
		$this->_actions = array(
				'display' => array(
				...
				'delete' => array(
						...
						'action_path' => '/announce_object/delete_announce_action',
