...
*
***********************************************************************************/
require_once(LIMB_SERVICE_NODE_DIR . '/validators/CommonEditServiceNodeValidator.class.php');

class EditTestContentServiceNodeValidator extends CommonEditServiceNodeValidator
{
