...
class ServiceNodeModifyCommand extends StateMachineCommand
{
  function ServiceNodeModifyCommand()
  {
    $entity_field_name = 'entity';

    $this->registerState('initial',
                         new LimbHandle(LIMB_DIR . '/core/commands/UseViewCommand',
                                        array('/service_node/edit.html')),
    ...
    $this->registerState('map_to_dataspace',
                          new LimbHandle(LIMB_SERVICE_NODE_DIR . '/commands/MapServiceNodeToDataspaceCommand',
                                         array($entity_field_name)),
    ...
    $this->registerState('validate',
                          new LimbHandle(LIMB_DIR .
                                         ...
                                         array('service_node_form',
                                               new LimbHandle(LIMB_SERVICE_NODE_DIR .
                                                              '/validators/ServiceNodeEditValidator'))),
