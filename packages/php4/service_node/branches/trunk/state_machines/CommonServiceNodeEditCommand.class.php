...
class CommonServiceNodeEditCommand extends StateMachineCommand
{
  function CommonServiceNodeEditCommand($template_path,
                                         $form_name)
  {
                          ...
                          new LimbHandle(LIMB_DIR .
                                         ...
                                         array($form_name,
                                               new LimbHandle(LIMB_SERVICE_NODE_DIR .
                                                              '/validators/CommonEditServiceNodeValidator'))),
