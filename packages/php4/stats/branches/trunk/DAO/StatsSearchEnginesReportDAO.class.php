...
class StatsSearchEnginesReportDAO extends SQLBasedDAO
{
  function & _initSQL()
  {
    ...
    $sql = new ComplexSelectSQL('SELECT master.phrase, master.engine, COUNT(engine) as hits %fields% FROM ' .
                                 'stats_search_phrase as master ' .
                                '%tables% %left_join% %where% ' .
                                'GROUP BY engine %group%' .
