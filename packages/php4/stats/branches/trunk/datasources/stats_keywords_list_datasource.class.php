...
require_once(LIMB_DIR . 'class/stats/stats_keywords_report.class.php');

class stats_keywords_list_datasource extends datasource
{		
	var $stats_report = null;
	
	function stats_keywords_list_datasource()
	{
