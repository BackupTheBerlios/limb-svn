...
require_once(dirname(__FILE__) . '/../reports/stats_referers_report.class.php');

class stats_referers_list_datasource extends stats_report_datasource
{		
	protected function _init_stats_report()
	{
		$this->_stats_report = new stats_referers_report();
	}
