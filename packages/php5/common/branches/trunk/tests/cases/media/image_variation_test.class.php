...
{ 
  ...
  function test_load_from_file()
  {
    ...
    $this->media_manager->setReturnValue('store', $media_id = 'sd3232cvc1op', array($file));
    ...
    $this->assertEqual($this->variation->get_media_id(), $media_id);    
  }
  ...
  { 
    ...
    $this->variation->set_media_id($media_id = 'sd3232cvc1op');//remember explicit calls are forbidden!!!
    
    $this->media_manager->setReturnValue('get_media_id_file_path', $media_file_path = 'media_path', array($media_id));
    ...
    $this->media_manager->setReturnValue('store', $new_media_id = 'fsdfsd7878sda', array($output_temp_file));
    ...
    $this->assertEqual($new_media_id, $this->variation->get_media_id());
	}
