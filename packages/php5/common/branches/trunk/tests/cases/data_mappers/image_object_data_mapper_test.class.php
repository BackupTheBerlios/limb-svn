...
{ 
  ...
  function test_insert()
  {
    ...
    $image_variation1->set_media_id($media_id1 = 'dsada');
    ...
    $image_variation2->set_media_id($media_id2 = 'dsfsdf');
    ...
    $this->assertEqual($media1['id'], $media_id1);
    ...
    $this->assertEqual($media2['id'], $media_id2);
    ...
    $this->assertEqual($variation_data1['media_id'], $media_id1);
    ...
    $this->assertEqual($variation_data2['media_id'], $media_id2);
  ...
  function test_update()
  {
    ...
    $this->db->sql_insert('image_variation', array('id' => $variation_id = 1000,
                                                   'media_id' => $old_media_id = '10sdsdszx210', 
                                                   'image_id' => $id = 100, 
                                                   'variation' => 'whatever'));
   
    $this->db->sql_insert('media', array('id' => $old_media_id, 
                                         'file_name' => 'file1', 
                                         'mime_type' => 'type1', 
                                         'size' => 20, 
                                         'etag' => 'etag1'));
    ...
    $image_variation1->set_width($width1 = 50);
    $image_variation1->set_height($height1 = 100);
    $image_variation1->set_media_id($media_id1 = 'dsada');//note it's a new one!!!
    $image_variation1->set_name($name1 = 'original');
    $image_variation1->set_etag($etag1 = 'dsajadhk');
    $image_variation1->set_mime_type($mime_type1 = 'jpeg');
    $image_variation1->set_size($size1 = 500);
    ...
    $this->media_manager->expectOnce('unlink_media', array($old_media_id));
