...
class create_navigation_item_form_command extends form_create_site_object_command
{
  protected function _define_datamap()
    ...
    $validator->add_rule(array(LIMB_DIR . '/class/validators/rules/required_rule', 'url'));
	}
}
