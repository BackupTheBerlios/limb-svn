...
class composite_user_object extends user_object
{
  ...
  {
    parent :: import_attributes($attributes);

    $this->_walk_node_objects('import_attributes', array('attributes' => $attributes));
  }

  function merge_attributes($attributes)
  {
    parent :: merge_attributes($attributes);

    $this->_walk_node_objects('merge_attributes', array('attributes' => $attributes));
  }
