...
require_once(TEST_CASES_DIR . '/fetching/content_object_fetch_test_init.php');

class test_content_object_fetch extends test_site_object_fetch 
{ 
	var $init_class_name = 'content_object_fetch_test_init';
	
  function test_content_object_fetch() 
  {
  	parent :: test_site_object_fetch();
  }
