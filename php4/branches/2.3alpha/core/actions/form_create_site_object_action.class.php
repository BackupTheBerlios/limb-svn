...
class form_create_site_object_action extends form_site_object_action
{
  ...
  function _init_validator()
  {
    if (($parent_node_id = $this->dataspace->get('parent_node_id')) === null)
    {
      ...
      $parent_node_id = $parent_object_data['node_id'];
    }
    ...
    $this->validator->add_rule($v[] = array(LIMB_DIR . '/core/lib/validators/rules/tree_identifier_rule', 'identifier', $parent_node_id));
  }
