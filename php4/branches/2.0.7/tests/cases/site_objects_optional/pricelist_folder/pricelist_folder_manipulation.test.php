...
class test_pricelist_folder_manipulation extends test_site_object_template 
{  	
  function test_pricelist_folder_manipulation() 
  {
  ...
  {
		$obj =& site_object_factory :: create('pricelist_folder');
  	return $obj;
  }
