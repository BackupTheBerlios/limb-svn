...
class test_site_object_auto_identifier extends UnitTestCase
{
  ...
  function test_create_simple()
  {
    ...
    $this->assertEqual($this->object->get_identifier(), '11');
  }

  function test_create_long_number()
  {
    debug_mock :: expect_never_write();

    $this->_create_node('9999');
    ...
    $this->assertEqual($this->object->get_identifier(), '10000');
  }
