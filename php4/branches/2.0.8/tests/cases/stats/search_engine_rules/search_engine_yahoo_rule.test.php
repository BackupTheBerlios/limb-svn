...
*
***********************************************************************************/ 
require_once(LIMB_DIR . '/core/model/stats/search_engine_rules/search_engine_yahoo_rule.class.php');

class test_search_engine_yahoo_rule extends UnitTestCase 
{
  var $rule = null;
	
  function test_search_engine_yahoo_rule() 
  {
  	parent :: UnitTestCase();
  }
