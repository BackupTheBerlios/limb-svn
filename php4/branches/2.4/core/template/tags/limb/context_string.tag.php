...
*
***********************************************************************************/
class limb_context_string_tag_info
{
  var $tag = 'limb:CONTEXT_STRING';
  var $end_tag = ENDTAG_FORBIDDEN;
  var $tag_class = 'limb_context_string_tag';
}

register_tag(new limb_context_string_tag_info());

class limb_context_string_tag extends server_component_tag
{
  var $runtime_component_path = '/core/template/components/limb_context_string_component';
