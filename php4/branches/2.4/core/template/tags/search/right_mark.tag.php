...
*
* Released under the LGPL license (http://www.gnu.org/copyright/lesser.html)
***********************************************************************************
*
* $Id$
*
***********************************************************************************/
class search_right_mark_tag_info
{
  var $tag = 'search:RIGHT_MARK';
  var $end_tag = ENDTAG_REQUIRED;
  var $tag_class = 'search_right_mark_tag';
}

register_tag(new search_right_mark_tag_info());

class search_right_mark_tag extends compiler_directive_tag
{
  function check_nesting_level()
  {
    if ($this->find_parent_by_class('search_right_mark_tag'))
    {
