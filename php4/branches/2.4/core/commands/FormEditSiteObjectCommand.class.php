...
class FormEditSiteObjectCommand extends FormCommand
{
  function _registerValidationRules(&$validator, &$dataspace)
  {
    ...
    $validator->addRule(array(LIMB_DIR . '/core/validators/rules/required_rule', 'identifier'));
    ...
    $validator->addRule(array(LIMB_DIR . '/core/validators/rules/tree_identifier_rule',
                                     'identifier',
                                     (int)$parent_node_id,
