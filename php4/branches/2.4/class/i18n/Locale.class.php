...
class Locale
{
  ...
  */
  function locale($locale_string = '')
  {
    ...
    {
      $this->is_valid = false;
      return new LimbException('Could not load country settings', array('country_code' => $this->country_code));
    }
    ...
    {
      $this->is_valid = false;
      return new LimbException('Could not load language settings', array('language_code' => $this->language_code));
    }
