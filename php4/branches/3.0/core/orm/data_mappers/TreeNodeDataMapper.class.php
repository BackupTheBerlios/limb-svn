...
***********************************************************************************
*
* $Id: TreeNodeDataMapper.class.php 1248 2005-04-19 15:07:09Z pachanga $
*
***********************************************************************************/
...
class TreeNodeDataMapper extends AbstractDataMapper
{
  ...
  {
    include_once(LIMB_DIR . '/core/orm/data_mappers/DefaultObjectIdentifierGenerator.class.php');
