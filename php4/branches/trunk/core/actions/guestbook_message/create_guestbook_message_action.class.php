...
class create_guestbook_message_action extends form_create_site_object_action
{
  ...
  function _init_validator()
  {
    ...
    $this->validator->add_rule($v1 = array(LIMB_DIR . '/core/lib/validators/rules/required_rule', 'sender'));
    $this->validator->add_rule($v2 = array(LIMB_DIR . '/core/lib/validators/rules/required_rule', 'message'));
