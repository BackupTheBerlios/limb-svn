...
*
***********************************************************************************/
class search_gaps_pattern_tag_info
{
  var $tag = 'search:GAPS_PATTERN';
  var $end_tag = ENDTAG_REQUIRED;
  var $tag_class = 'search_gaps_pattern_tag';
}

register_tag(new search_gaps_pattern_tag_info());

class search_gaps_pattern_tag extends compiler_directive_tag
{
  function check_nesting_level()
  {
    if ($this->find_parent_by_class('search_gap_pattern_tag'))
    {
