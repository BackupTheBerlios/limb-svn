...
class cart_test extends UnitTestCase
{
  ...
  function test_get_items_array_dataset()
  {
    ...
    $item1->expectOnce('export_attributes');
    $item1->setReturnValue('export_attributes', array('id' => 'some_id1'));
    
    $item2->expectOnce('export_attributes');
    $item2->setReturnValue('export_attributes', array('id' => 'some_id2'));
