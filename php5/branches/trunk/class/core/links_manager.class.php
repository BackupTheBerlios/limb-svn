...
{  
  ...
  {
    $group_db_table = db_table_factory :: create('sys_node_link_group');
  ...
  {
    db_table_factory :: create('sys_node_link_group')->delete_by_id($group_id);
  }
  ...
  {
    return db_table_factory :: create('sys_node_link_group')->get_list('', 'priority ASC');
  }
  ...
  {
    return db_table_factory :: create('sys_node_link_group')->get_row_by_id($group_id);
  }
  ...
  public function create_link($group_id, $linker_object_id, $target_object_id)
  {
    ...
    $link_db_table = db_table_factory :: create('sys_node_link');
  ...
  {
    db_table_factory :: create('sys_node_link')->delete_by_id($link_id);
  }
