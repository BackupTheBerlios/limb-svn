...
class data_mapper_file_resolver extends file_resolver_decorator
{
  ...
  {
    if(file_exists(LIMB_DIR . '/class/core/mappers/' . $class_path . '.class.php'))
      return LIMB_DIR . '/class/core/mappers/' . $class_path . '.class.php';    
      
    return $this->_resolver->resolve('mappers/' . $class_path . '.class.php', $params);   
  }  
}
